...
import com.acromere.curve.math.Intersection2D;
...
public class Line2D extends Shape {
	...
	public static Intersection2D segmentIntersection( Line2D a, Line2D b ) {
		return com.acromere.curve.math.Intersection2D.intersectSegmentSegment( a.a.toArray(), a.b.toArray(), b.a.toArray(), b.b.toArray() );
	}
