...
public class AirfoilStationPointCodecTest {
	...
	void testLoadWithNiceAirfoil() throws Exception {
		...
		assertThat( airfoil.getMaxY() ).isEqualTo( 0.0914113436006981 );
		assertThat( airfoil.getMinY() ).isEqualTo( -0.030159154589405237 );
	}
	...
	void testLoadWithMultiInflectionAirfoil() throws Exception {
		...
		assertThat( airfoil.getMaxY() ).isEqualTo( 0.023750195058533246 );
		assertThat( airfoil.getMinY() ).isEqualTo( -0.023749433989284925 );
	}
	...
	void testLoadWithAsymmetricStationAirfoil() throws Exception {
		...
		assertThat( airfoil.getMaxY() ).isEqualTo( 0.09201546304338426 );
		assertThat( airfoil.getMinY() ).isEqualTo( -0.0026206622724435254 );
	}
	...
	void testLoadLednicer() {
		...
		assertThat( foil.getUpperDefinitionPoints().get( index++ ) ).isEqualTo( new Point2D( 0.3600547553850096, 0.0914113436006981 ) );
		...
		assertThat( foil.getLowerDefinitionPoints().get( index++ ) ).isEqualTo( new Point2D( 0.16001806533036336, -0.030159154589405237 ) );
